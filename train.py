...
if __name__ == '__main__':
    ...
    print('使用的设备是:',device)
    # data info
    train_loader = DataLoader(dataset=Train_Dataset(args),batch_size=args.batch_size,num_workers=0, shuffle=True)
    val_loader = DataLoader(dataset=Val_Dataset(args),batch_size=1,num_workers=0, shuffle=False)
